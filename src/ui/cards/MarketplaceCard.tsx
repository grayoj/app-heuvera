    ...
    <>
      <div className='rounded-md sm:w-full md:w-72 h-auto sm:h-auto md:h-80 mx-4 my-2.5'>
        ...
        <div className='m-2 sm:m-2 md:m-1.5'>
          <h1 className='font-inter text-2xl sm:text-xl md:text-xl text-black'>
            Oakridge Cottage
          </h1>
          <h1 className='font-inter text-base sm:text-base md:text-base text-gray-700'>
            Edgbaston
          </h1>
          <div className='flex justify-between mt-1'>
            <div className=''>
              <h1 className='text-purple-600 font-bold text-lg sm:text-base md:text-lg font-inter'>
                $57
                <span className='text-xs text-gray-800 font-medium px-2'>
                  Per night
                </span>
              </h1>
            </div>
